...
insert into psychic_schools (psychic_name, psychic_text) values ('School of Order', '');
insert into psychic_schools (psychic_name, psychic_text) values ('School of Disorder', '');
